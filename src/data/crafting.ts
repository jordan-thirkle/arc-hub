...
export const craftingRecipes: CraftingRecipe[] = [
  ...
  // ── Crafting Stations ──
  {
    ...
    materials: [
      { id: 'scrap-metal', name: 'Scrap Metal — common drop from containers, robots' },
      { id: 'polymer', name: 'Polymer — found in industrial areas, Sector 1' },
      { id: 'screw-set', name: 'Screw Set — toolboxes, maintenance rooms' },
      { id: 'titanium-alloy', name: 'Titanium Alloy — rare, Sector 4+ or boss loot' },
      { id: 'circuit-board', name: 'Circuit Board — electronics, offices, Sector 2' },
      { id: 'spring-kit', name: 'Spring Kit — mechanical crates, garages' },
      { id: 'energy-cell', name: 'Energy Cell — tech labs, Sector 4-5' },
      { id: 'gunpowder', name: 'Gunpowder — ammo crates, explosives bench' },
      { id: 'chemicals', name: 'Chemicals — medical areas, labs, Sector 2' },
      { id: 'fabric', name: 'Fabric — medical areas, suitcases' },
    ],
  },
];
