import type { Weapon, WeaponTier, WeaponStat, WeaponClass, AmmoType, AttachmentSlot } from '../types.js';
...
export const weapons: Weapon[] = [
  ...
  w({
    ...
    description:
      'An experimental weapon that can either fire a wide short range blast, or be focused to fire a tight medium range beam of heat.',
    rarity: 'Legendary',
    tiers: [
      {
        tier: 0,
  ...
  w({
    ...
    description:
      'Single-shot grenade launcher introduced alongside the Nomadic Envoy. Devastating explosive damage with significant splash radius.',
    rarity: 'Rare',
    tiers: [
      {
        tier: 0,
