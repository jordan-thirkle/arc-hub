...
export const metaBuilds: MetaBuild[] = [
  {
    ...
    votes: 3421,
    author: 'ArcMeta',
    tags: ['pvp', 'meta', 'aggressive', 'medium-shield'],
  },
  {
  ...
  },
  {
    ...
    votes: 1843,
    author: 'GhostMain',
    tags: ['stealth', 'sniper', 'rat', 'silencer'],
  },
  {
    ...
    votes: 5620,
    author: 'BudgetKing',
    tags: ['budget', 'starter', 'zero-to-hero'],
  },
  {
    id: 'meta-ferro-boss',
    ...
    build: {
      ...
      secondaryWeaponId: 'venator',
      secondaryTier: 2,
      secondaryAttachments: [{ slot: 'underbarrel', attachmentId: 'vertical-grip' }],
  ...
  },
  {
    ...
    votes: 756,
    author: 'MedicMain',
    tags: ['support', 'medic', 'squad', 'anvil'],
  },
  {
    id: 'meta-bobcat-rat',
    ...
    votes: 4521,
    author: 'RatKing',
    tags: ['rat', 'budget', 'zero-to-hero', 'stealth'],
  },
  {
    ...
    votes: 534,
    author: 'LMGFan',
    tags: ['lmg', 'suppression', 'squad', 'heavy'],
  },
  {
    ...
    build: {
      ...
      secondaryWeaponId: 'venator',
      secondaryTier: 1,
      secondaryAttachments: [{ slot: 'medium-magazine', attachmentId: 'extended-medium-mag' }],
      augmentId: 'breacher',
      shieldId: 'medium-shield',
    ...
    votes: 1678,
    author: 'SoloPlayer',
    tags: ['allrounder', 'solo', 'versatile', 'energy'],
  },
  {
    id: 'meta-iltoro-cqb',
    ...
    votes: 892,
    author: 'Shotgunner',
    tags: ['cqb', 'shotgun', 'looting', 'hybrid'],
  },
  {
    ...
    build: {
      name: 'Equalizer Endgame',
      primaryWeaponId: 'equalizer',
      primaryTier: 3,
      primaryAttachments: [],
      secondaryWeaponId: 'jupiter',
      secondaryTier: 3,
      secondaryAttachments: [],
    ...
    votes: 2103,
    author: 'EndgameGod',
    tags: ['endgame', 'legendary', 'sector-6', 'boss'],
  },
  {
    ...
    build: {
      ...
      secondaryWeaponId: 'hairpin',
      secondaryTier: 2,
      secondaryAttachments: [{ slot: 'light-magazine', attachmentId: 'extended-light-mag' }],
    ...
    votes: 645,
    author: 'LootMax',
    tags: ['pve', 'farming', 'loot-max', 'shotgun'],
  },
  {
    ...
    votes: 432,
    author: 'ScoutSix',
    tags: ['stealth', 'scout', 'smg', 'tactical'],
  },
  {
    ...
    votes: 1123,
    author: 'AnchorMain',
    tags: ['allrounder', 'squad', 'mid-range', 'burst'],
  },
];
