    ...
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3 text-[9px] font-mono text-tertiary">
          <span>Points: <span className="text-primary">{totalPoints}</span>/91</span>
        ...
        <div className="flex items-center gap-2 text-[8px] text-tertiary">
          <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full" style={{ background: '#E8A832' }} /> Conditioning</span>
          <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full" style={{ background: '#4CAF50' }} /> Mobility</span>
          <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full" style={{ background: '#03A9F4' }} /> Survival</span>
        </div>
      </div>
      <div className="h-[600px] border border-[rgb(var(--border-primary))]">
        ...
        >
          ...
          <Controls showInteractive={false} className="[&_button]:!bg-surface [&_button]:!border-[rgb(var(--border-primary))] [&_button]:!text-primary" />
          <MiniMap
            nodeColor={(n) => {
