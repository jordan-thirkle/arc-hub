const GEAR = [
  { name: 'SteelSeries Arctis Nova Pro', desc: 'Best gaming headset for extraction shooters', url: 'https://steelseries.com/arctis-nova-pro', tag: 'Headset' },
  { name: 'Razer DeathAdder V3 Pro', desc: 'Lightweight precision mouse', url: 'https://razer.com/deathadder-v3-pro', tag: 'Mouse' },
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="space-y-1">
        {GEAR.map(item => (
          <button key={item.name} onClick={() => handleClick(item.url)}
