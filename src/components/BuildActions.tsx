        ...
        {showSaved && (
          <div className="border border-[rgb(var(--border-primary))] bg-surface max-h-48 overflow-y-auto rounded-md shadow-card">
            {savedBuilds.length === 0 ? (
              ...
              savedBuilds.map(b => (
                <div key={b.id} className="flex items-center justify-between px-3 py-2 border-b border-[rgb(var(--border-primary))] last:border-0 hover:bg-[rgb(var(--bg-elevated))] transition-colors">
