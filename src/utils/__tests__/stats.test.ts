...
const makeWeapon = (overrides: Partial<Weapon> = {}): Weapon => ({
  ...
  rarity: 'Common',
  tiers: [
    { tier: 0 as WeaponTier, label: 'I', stats: {
      damage: 10, fireRate: 30, range: 50, dps: 300,
      magSize: 20, verticalRecoil: 25, horizontalRecoil: 15,
      adsSpeed: 0.35, reloadSpeed: 2.2, bulletVelocity: 550, dispersion: 1.8,
      agility: 50, stability: 50, stealth: 10,
    }, value: 1000, weight: 5 },
    { tier: 1 as WeaponTier, label: 'II', stats: {
      damage: 11, fireRate: 32, range: 55, dps: 352,
      magSize: 24, verticalRecoil: 23, horizontalRecoil: 14,
      adsSpeed: 0.33, reloadSpeed: 2.1, bulletVelocity: 550, dispersion: 1.7,
      agility: 52, stability: 52, stealth: 10,
    }, value: 2000, weight: 5 },
  ],
...
describe('statLabel', () => {
  it('returns readable labels for all stat keys', () => {
    const keys: (keyof WeaponStat)[] = [
      'damage', 'fireRate', 'range', 'dps', 'magSize',
      'verticalRecoil', 'horizontalRecoil', 'adsSpeed',
      'reloadSpeed', 'bulletVelocity', 'dispersion',
      'agility', 'stability', 'stealth',
    ];
